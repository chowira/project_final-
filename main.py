...
if __name__ == '__main__':
    ...
    fun.guardar_dataframe_interactivo_interacciones(df_interacciones_porcesado,carpeta_4)
    ...
    fun.guardar_dataframe_interactivo_usuarios(df_usuarios_map_nulos, carpeta_4)
    df_canales = fun.leer_unico_csv_canales(carpeta_3)
    df_canales_new = fun.seleccionar_columnas_canales(df_canales)
    fun.guardar_dataframe_interactivo_canales(df_canales_new,carpeta_4)
